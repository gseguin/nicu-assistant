...
- [ ] **Phase 32: GIR Simplification** — Remove summary hero card, per-card secondary metrics row, reference card; preserve click/tap visual treatment; drop `aria-live`; fix severe-neuro STOP gating (deferred from v1.9)
...
| 32. GIR Simplification | v1.10 | 0/0 | Not started | - |

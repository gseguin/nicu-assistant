...
---
*Last updated: 2026-05-28 — v1.18 Phase 55 complete: extracted the `PersistentValue<T>` persistence seam (guarded read/write/remove + JSON-or-raw codec + recover hook) with 26 co-located tests as the single persistence test surface (SEAM-01..04). Behavior-preserving; no adapter migrated yet. Next: Phase 56 migrates theme/disclaimer/favorites/lastEdited onto the seam.*

...
---
*Last updated: 2026-05-28 — v1.18 Phase 56 complete: migrated theme/disclaimer/favorites/lastEdited onto the `PersistentValue<T>` seam as thin behavior-preserving adapters (byte-identical keys/shapes; FOUC raw-read intact; disclaimer v1 audit trail preserved; three regression suites green with zero edits). vitest 448/448, svelte-check 0/0, verified 9/9. Next: Phase 57 folds the copy-pasted auto-persist `$effect` behind `CalculatorStore`.*

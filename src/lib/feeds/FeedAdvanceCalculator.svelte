...
<div class="space-y-6">
  ...
  {#if feedsState.current.mode === 'bedside'}
          ...
          <div class="flex items-baseline justify-between px-5 py-4">
            <div>
              ...
              <div class="flex items-baseline gap-2">
                <span class="text-title font-bold num text-[var(--color-text-primary)]">
                  {bedsideResult.trophicMlPerFeed.toFixed(1)}
                </span>
                <span class="text-ui text-[var(--color-text-secondary)]">ml/feed</span>
              </div>
            </div>
            <span class="text-ui num text-[var(--color-text-tertiary)]">
    ...
    <section class="card flex flex-col gap-4 px-5 py-5">
      {#if bedsideResult}
        <div>
          <div class="text-2xs font-semibold uppercase tracking-wide text-[var(--color-text-tertiary)]">
      ...
      {#if ivBackfillRate != null}
        <div>
          ...
          <p class="text-2xs text-[var(--color-text-tertiary)] mt-1">

...
// run all e2e specs by default). 5 routes x 2 projects = 10 cases.
//
// Pattern source: e2e/mobile-nav-clearance.spec.ts (route-loop + addInitScript) +
// e2e/feeds.spec.ts:35 (drawer-open trigger).
//
// IMPORTANT: ROUTES lists EVERY active calculator route — FOCUS-03 requires every
// drawer-bearing route to be covered, no omissions.
